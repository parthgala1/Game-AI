      ...
      <div className="container mx-auto px-4 py-12">
        ...
        >
          <div className="bg-space-medium/30 border border-space-neon-green/30 rounded-lg p-6 mb-8">
            <h2 className="text-xl font-future neon-text mb-6">
              Audio Settings
            </h2>
            ...
            <div className="space-y-6">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  {settings.soundEnabled ? (
                    <Volume2 size={20} className="text-space-neon-green" />
                  ) : (
                    <VolumeX size={20} className="text-space-neon-pink" />
                  )}
              ...
              <div className="space-y-2">
                ...
                <Slider
                  ...
                  onValueChange={(value) =>
                    setSettings((prev) => ({ ...prev, masterVolume: value[0] }))
                  }
                />
              </div>
          ...
          <div className="bg-space-medium/30 border border-space-neon-blue/30 rounded-lg p-6 mb-8">
            <h2 className="text-xl font-future neon-blue-text mb-6">
              Gameplay Settings
            </h2>
            ...
            <div className="space-y-6">
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-3 gap-2 mt-2">
                  <button
                    ...
                    onClick={() =>
                      setSettings((prev) => ({ ...prev, difficulty: "easy" }))
                    }
                  >
                    Easy
                  </button>
                  <button
                    ...
                    onClick={() =>
                      setSettings((prev) => ({ ...prev, difficulty: "medium" }))
                    }
                  >
                    Medium
                  </button>
                  <button
                    ...
                    onClick={() =>
                      setSettings((prev) => ({ ...prev, difficulty: "hard" }))
                    }
                  >
                    Hard
                  </button>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  {settings.particleEffects ? (
                    <Zap size={20} className="text-space-neon-green" />
                  ) : (
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    setSettings((prev) => ({ ...prev, screenShake: checked }))
                  }
                />
              </div>
            </div>
          ...
          <div className="bg-space-medium/30 border border-space-neon-purple/30 rounded-lg p-6 mb-8">
            <h2 className="text-xl font-future neon-pink-text mb-6">
              Visual Settings
            </h2>
